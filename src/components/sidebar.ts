...
export function createSidebar(opts: SidebarOptions): SidebarResult {
  ...
  toggleBtn.innerHTML = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="18" x2="21" y2="18"/></svg>';
  ...
  for (const item of opts.items) {
    ...
    itemEl.addEventListener('click', () => {
      nav.querySelectorAll('.osx-sidebar-item').forEach(el => el.classList.remove('active'));
